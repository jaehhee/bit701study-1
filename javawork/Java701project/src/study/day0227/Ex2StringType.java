...
public class Ex2StringType {
	...
	public static void main(String[] args) {
		...
		System.out.println("s4의 length="+s4.trim().length());//5,s4의 값에서 앞뒤공백을 제거한후 길이구하기
		...
		System.out.println(msg.indexOf('a'));//처음 만난 a의 인덱스 반환, 1
		...
		//문자열같은 경우는 정확하게 값으로 비교하려면 위의 두메서드를 사용
		...
		System.out.println(m1.compareTo("Apple"));//두변수의 값이 완전히 같을경우 0이 나온다
		System.out.println("computer".compareTo("command"));//'p','m' 을 비교 p(112),m(109): 3(양수값은 앞의 값이 더 크다는 뜻)
